    ...
    <div ref="LoginModal" p-2 w-full border-rd-2 max-w-80 mx-auto block class="form">
      <FormKit type="form" :submit-attrs="{ inputClass: 'mt-5 btn-primary' }" @submit="submit">
        <FormKit
          ...
          help-class="text-sm text-gray"
          input-class="b-rd-md p-1.5 b-1 b-black"
          type="text" label="Username" help="Pick a new username."
        ...
        <FormKit
          ...
          help-class="text-sm text-gray"
          input-class="b-rd-md p-1.5 b-1 b-black"
          type="password" label="Password" name="password" help="Pick a new password."
          validation="required|length:5,15|matches:/[0-9]/" validation-visibility="dirty" :validation-messages="{
            matches: 'Must include at least one number',
          }"
        />
        <FormKit
          ...
          input-class="b-rd-md p-1.5 b-1 b-black"
          message-class=""
          type="password" name="password_confirm" label="Confirm password" help="Confirm your password."
